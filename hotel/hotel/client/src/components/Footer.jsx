...
const Footer = () => {
  return (
    <div className=" bottom-0 left-0 w-full text-white bg-gray-900/30 py-4 px-6 md:px-16 lg:px-24 xl:px-32">
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.log} alt="logo" className=' mb-0 h-27 md:h-30' />
                    <p className='text-sm mt-0'>
                        GrayHotel Provides you comfort luxury lifestyle best food and each n everything you want.Stay happy with Grayhotels... 
                    </p>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        <input type="text" className='bg-gray rounded-1 border border-gray-300 h-9 px-3 outline-none' placeholder='Your email' />
