...
const NewsLetter = () => {
  return (
        ...
        <div className="flex flex-col items-center w-full max-w-2xl  rounded-2xl px-4 py-10 md:py-16 mx-2 lg:mx-auto my-10 bg-gray-700/30 text-white">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-7">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                    <img src={assets.Arrow} alt="arrow" className='group-hover:translate-x-2 transition-all' />                </button>
            </div>
